/*
 * Unified cancer / non-cancer patient events for ML training — BLADDER TRAINING.
 *
 * HOLD-OUT EXCLUSION: patients in bladder_cancer_600 and no_cancer_bladder_50000 (the real-world
...
WITH params AS (
  SELECT
    ...
    'bladder%'          AS target_cancer_pattern        --      Specify the target cancer
