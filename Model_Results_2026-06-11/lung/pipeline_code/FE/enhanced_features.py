"""
Enhanced per-patient FE for the Lung B+C model (Keerthii / improved branch).

Adds transform-features that Abbas's FE does not compute, proven useful in our other
...
# Time bins (months before anchor). The cohort excludes the last 12mo, so the most-recent
# allowed events sit at ~12mo. Bins: recent 12-18, mid 18-30, old 30-54.
BIN_RECENT = (12.0, 18.0)
BIN_MID = (18.0, 30.0)
BIN_OLD = (30.0, 54.0)
RECENT_RATIO_CUTOFF = 24.0   # "recent" = within the most-recent 12-24mo allowed band
