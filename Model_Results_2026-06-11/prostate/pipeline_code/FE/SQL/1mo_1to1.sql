/*
 * Unified cancer / non-cancer patient events for ML training — PROSTATE TRAINING.
 *
 * HOLD-OUT EXCLUSION: patients in prostate_cancer_1500 and no_cancer_prostate_50000 (the real-world
