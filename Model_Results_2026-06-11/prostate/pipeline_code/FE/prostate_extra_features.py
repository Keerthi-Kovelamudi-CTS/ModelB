"""
Prostate EXTRA features — computed post-FE from the raw cohort events, which carry signals the
...
These columns were NEVER used as features before; this is the prostate analogue of what lung did.
...
non-cancer 80%. See memory: prostate_extra_features_leakage.
"""
import json
import os
import numpy as np
...
# Standard FBC SNOMED codes (cancer-agnostic; not in the prostate codelist but present in the raw
