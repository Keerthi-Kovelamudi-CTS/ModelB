...
Reads:  data/raw/breast_{window}_raw.csv   (output of SQL Queries/v4/{window}_v4.sql)
Writes: data/{window}/breast_{window}.csv  (single unified file — obs + med UNION'd)
...
def main():
    ...
    ap.add_argument("--prefix",  default="breast_1mo",            help="output filename prefix")
    args = ap.parse_args()
