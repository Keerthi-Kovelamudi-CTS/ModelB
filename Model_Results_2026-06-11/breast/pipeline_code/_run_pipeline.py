...
def export_query_to_csv(sql, out_csv, project_id=PROJECT_ID,
                        gcs_prefix="gs://cancer_transformed_ai/breast_bc", tag=None):
...
def run_fe(window, ratio, out_dir, project_id=PROJECT_ID, time_window_months=None,
           gcs_prefix="gs://cancer_transformed_ai/breast_bc"):
    ...
    mat = fe.extract_breast_risk_factors(csv_path, time_window_months=time_window_months)
