"""
╔══════════════════════════════════════════════════════════════════╗
║  LYMPHOMA CANCER — Phase 1.3                                   ║
║  Combined Feature Ranking (Statistical + ML)                   ║
║                                                                ║
║  Input Files (from Data_Input/):                               ║
║    - Lymphoma_positive_obs.csv, Lymphoma_negative_obs.csv                  ║
║    - Lymphoma_positive_med.csv, Lymphoma_negative_med.csv                  ║
║                                                                ║
║  Output Files: output/Scores_lymphoma/                         ║
...
CONFIG = {
    ...
    'data_dir': _DATA_DIR,
    'input_files': {
        'pos_obs':         'Lymphoma_positive_obs.csv',
        'neg_obs':         'Lymphoma_negative_obs.csv',
        'pos_meds':        'Lymphoma_positive_med.csv',
        'neg_meds':        'Lymphoma_negative_med.csv',
    },
