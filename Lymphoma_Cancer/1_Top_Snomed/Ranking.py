"""
╔══════════════════════════════════════════════════════════════════╗
║  PRODUCTION — LYMPHOMA — Phase 1.3                             ║
║  Combined Feature Ranking (Statistical + ML)                   ║
║  Version: 1.1 FINAL                                            ║
║                                                                ║
║  Input Files (from Data_Input/):                               ║
║    - Lym_positive_obs.csv, Lym_negative_obs.csv                ║
║    - Lym_positive_med.csv, Lym_negative_med.csv                ║
║    - Lym_patient_obs_matrix.csv  (optional)                    ║
║    - Lym_patient_meds_matrix.csv (optional)                    ║
║                                                                ║
║  Output Files: Scores/output/Scores_lymphoma/                  ║
║      - lymphoma_obs_top150.csv                                 ║
║      - lymphoma_meds_top150.csv                                ║
║      - lymphoma_combined_top150.csv     ← FINAL DELIVERABLE   ║
║      - lymphoma_obs_all.csv                                    ║
║      - lymphoma_meds_all.csv                                   ║
║      - lymphoma_combined_all.csv                               ║
...
║                                                                ║
║  Run: python PROD_lymphoma_feature_ranking_FINAL.py            ║
...
CONFIG = {
    ...
    'data_dir': _DATA_DIR,
    'input_files': {
        'pos_obs':         'Lym_positive_obs.csv',
        'neg_obs':         'Lym_negative_obs.csv',
        'pos_meds':        'Lym_positive_med.csv',
        'neg_meds':        'Lym_negative_med.csv',
        'obs_matrix':      'Lym_patient_obs_matrix.csv',
        'meds_matrix':     'Lym_patient_meds_matrix.csv',
    },
    ...
    'output_dir': os.path.join(_SCRIPT_DIR, 'output', 'Scores_lymphoma'),
