...
Reads:  data/raw/melanoma_{window}_raw.csv   (output of SQL Queries/v4/{window}_v4.sql)
Writes: data/{window}/melanoma_{window}.parquet  (single unified file — obs + med UNION'd)
...
DEFAULT_RAW = SCRIPT_DIR / "data" / "raw" / "melanoma_1mo_raw.csv"
...
def main():
    ...
    ap.add_argument("--prefix",  default="melanoma_1mo",            help="output filename prefix")
    args = ap.parse_args()
