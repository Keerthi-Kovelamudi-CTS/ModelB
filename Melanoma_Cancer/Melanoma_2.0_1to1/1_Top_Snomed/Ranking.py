"""
╔══════════════════════════════════════════════════════════════════╗
║  MELANOMA CANCER — Phase 1.3                                   ║
║  Combined Feature Ranking (Statistical + ML)                   ║
║                                                                ║
║  Input Files (from Data_Input/):                               ║
║    - Melanoma_positive_obs.csv, Melanoma_negative_obs.csv                  ║
║    - Melanoma_positive_med.csv, Melanoma_negative_med.csv                  ║
║                                                                ║
║  Output Files: output/Scores_melanoma/                         ║
...
CONFIG = {
    ...
    'data_dir': _DATA_DIR,
    'input_files': {
        'pos_obs':         'Melanoma_positive_obs.csv',
        'neg_obs':         'Melanoma_negative_obs.csv',
        'pos_meds':        'Melanoma_positive_med.csv',
        'neg_meds':        'Melanoma_negative_med.csv',
    },
