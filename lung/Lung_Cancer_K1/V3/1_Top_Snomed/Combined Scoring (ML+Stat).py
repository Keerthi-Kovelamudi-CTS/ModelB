...
HORIZONS = ["12mo", "1mo"]      # both horizons by default
if len(sys.argv) > 1:           # e.g. `python "Combined Scoring (ML+Stat).py" 12mo 5` (horizon [years])
...
YEARS = next((int(a) for a in sys.argv[1:] if a.isdigit()), 5)
