...
def split_using_shared_assignment(X, y, shared_split):
    ...
    return (
        X[in_train], X[in_val], X[in_test],
        y[in_train], y[in_val], y[in_test],
    )
...
def run_modeling():
    ...
    for window in WINDOWS:
        ...
        if SHARED_SPLIT_PATH.exists():
            ...
            X_train, X_val, X_test, y_train, y_val, y_test = split_using_shared_assignment(X, y, shared_split)
            logger.info(
