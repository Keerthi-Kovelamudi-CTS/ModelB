#!/bin/bash
# ════════════════════════════════════════════════════════════════
# Prostate_2.0_1to1 — Phase 1.1: Run 4 P1 SQLs on BigQuery and
...
#
# Output:
#   Data_Input/Pro_positive_obs.csv
#   Data_Input/Pro_negative_obs.csv
#   Data_Input/Pro_positive_med.csv
#   Data_Input/Pro_negative_med.csv
#
