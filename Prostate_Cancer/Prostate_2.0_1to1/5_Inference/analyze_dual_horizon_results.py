...
Inputs:
  - 5_Inference/test_dual_horizon_per_patient.csv  (must exist; produced by test_dual_horizon_local.py)
...
Outputs:
  - 5_Inference/test_dual_horizon_per_patient_full.csv  (CSV + 2 new SHAP columns)
  - 5_Inference/dual_horizon_threshold_sweep.csv        (operating-point table)
  - 5_Inference/dual_horizon_age_band_metrics.csv       (per-band AUC/Sens/Spec)
