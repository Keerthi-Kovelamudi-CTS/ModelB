...
EXPLAINABILITY_CLASS = {
    ...
    # ══════════════════════════════════════════════════════════
    # ETHNICITY — direct (patient demographic)
    # ══════════════════════════════════════════════════════════
    'ETH_':             'direct',
...
CLINICAL_DESCRIPTIONS = {
    ...
    'PROST_LAB_psa_age_band_percentile':  "PSA percentile within the patient's 10-year age band (0-1)",
    'PROST_LAB_psa_age_band_top10pct':    "PSA in top 10% for the patient's age band",
    'PROST_LAB_psa_age_band_top5pct':     "PSA in top 5% for the patient's age band",
    ...
    'PROST_RF_black_ethnicity':     'Patient is Black (higher prostate cancer incidence and aggressiveness)',
    'PROST_RF_ethnicity_not_specified': 'Patient ethnicity not recorded in the notes',
    'PROST_RF_black_and_elderly':   'Patient is Black AND over 65 (highest prostate cancer risk demographic)',

    # ── Ethnicity one-hots ────────────────────────────────────
    'ETH_WHITE':         'Patient ethnicity: White',
    'ETH_ASIAN':         'Patient ethnicity: Asian',
    'ETH_BLACK':         'Patient ethnicity: Black',
    'ETH_CHINESE':       'Patient ethnicity: Chinese',
    'ETH_MIXED':         'Patient ethnicity: Mixed',
    'ETH_OTHER':         'Patient ethnicity: Other',
    'ETH_NOT_SPECIFIED': 'Patient ethnicity not recorded',

    # ── PSA trajectory (velocity / pct change) ────────────────
    'PROST_LAB_psa_velocity':          'PSA rate of change: {value} ng/mL per month',
    'PROST_LAB_psa_velocity_per_year': 'PSA rate of change: {value} ng/mL per year (clinical standard)',
    'PROST_LAB_psa_velocity_high':     'PSA rising faster than 0.75 ng/mL/year (suspicious)',
    'PROST_LAB_psa_velocity_very_high': 'PSA rising faster than 2.0 ng/mL/year (high concern)',
    'PROST_LAB_psa_pct_change':        'PSA percent change across window: {value}%',
    'PROST_LAB_psa_pct_up_50':         'PSA has risen by more than 50% over the observation window',
    'PROST_LAB_psa_pct_up_100':        'PSA has more than doubled over the observation window',

    # ── Critical-code flags ───────────────────────────────────
    'PROST_HAS_FRANK_HAEMATURIA':       'Frank (visible) haematuria recorded',
    'PROST_HAS_MICROSCOPIC_HAEMATURIA': 'Microscopic (non-visible) haematuria recorded',
    'PROST_HAS_DRE_ABNORMAL':           'Abnormal digital rectal examination recorded',
    'PROST_HAS_RAISED_PSA':             'PSA explicitly flagged as raised in coded data',
    'PROST_HAS_PSA_ABNORMAL':           'PSA flagged as abnormal in coded data',
    'PROST_HAS_URINARY_RETENTION_CODE': 'Urinary retention explicitly coded',
    'PROST_HAS_BONE_METS_CODE':         'Bone metastasis explicitly coded (red flag for advanced disease)',
    'PROST_HAS_PROSTATE_BIOPSY':        'Prostate biopsy performed',

    # ── Smoking granularity ───────────────────────────────────
    'PROST_HAS_CURRENT_SMOKER':         'Current smoker',
    'PROST_HAS_FORMER_SMOKER':          'Former smoker (ex-smoker / cessation documented)',
    'PROST_HAS_NEVER_SMOKER':           'Never smoker',

    # ── Family history granularity ────────────────────────────
    'PROST_HAS_FAMHX_PROSTATE_CA':      'Family history of prostate cancer',
    'PROST_HAS_FAMHX_ANY_CANCER':       'Family history of any cancer',
    'PROST_HAS_FAMHX_MALE_GENITAL_CA':  'Family history of male genital tract cancer',

    # ── Lab missingness indicators ────────────────────────────
    'LAB_PSA_is_missing':                    'PSA was never measured in the observation window',
    'LAB_FBC_HAEMATOLOGY_is_missing':        'Full blood count was not measured in the observation window',
    'LAB_RENAL_FUNCTION_is_missing':         'Renal function was not measured in the observation window',
    'LAB_LIVER_FUNCTION_is_missing':         'Liver function was not measured in the observation window',
    'LAB_ELECTROLYTES_is_missing':           'Electrolytes panel was not measured in the observation window',
    'LAB_ALBUMIN_PROTEIN_is_missing':        'Albumin/protein was not measured in the observation window',
    'LAB_ALP_BONE_MARKER_is_missing':        'Alkaline phosphatase was not measured in the observation window',
    'LAB_CALCIUM_is_missing':                'Calcium was not measured in the observation window',
    'LAB_HAEMATOLOGY_is_missing':            'Haematology panel was not measured in the observation window',
    'LAB_URINE_MARKERS_is_missing':          'Urine markers were not measured in the observation window',
    'LAB_VITAMIN_D_is_missing':              'Vitamin D was not measured in the observation window',
    'LAB_HORMONAL_is_missing':               'Hormonal panel was not measured in the observation window',
    'LAB_COAGULATION_is_missing':            'Coagulation was not measured in the observation window',

    # ── Lab direction-aware worsening flags ───────────────────
    'LAB_PSA_worsening':                 'PSA trending upward (clinically unfavourable)',
    'LAB_ALP_BONE_MARKER_worsening':     'Alkaline phosphatase trending upward (possible bone involvement)',
    'LAB_RENAL_FUNCTION_worsening':      'Renal function (eGFR) trending downward (clinically unfavourable)',
    'LAB_FBC_HAEMATOLOGY_worsening':     'Haemoglobin trending downward (developing anaemia)',
    'LAB_HAEMATOLOGY_worsening':         'Inflammation markers (CRP) trending upward',
    'LAB_ALBUMIN_PROTEIN_worsening':     'Albumin trending downward (catabolic / advanced disease signal)',
    'LAB_LIVER_FUNCTION_worsening':      'Liver function markers trending upward',
    'LAB_CALCIUM_worsening':             'Calcium trending upward (possible bone involvement)',
    'LAB_HORMONAL_worsening':            'Testosterone trending downward',
    'LAB_VITAMIN_D_worsening':           'Vitamin D trending downward',
