...
CLINICAL_DESCRIPTIONS = {
    ...
    'PROST_RF_over65_with_psa_elevated': 'Patient over 65 with elevated PSA (>4)',
    ...
    'PROST_RF_over65_with_psa_elevated': 'Over 65 with elevated PSA (>4 ng/mL)',
    ...
    # ── Block 9: composite / value-based ──────────────────────
    'PROST_LAB_ipss_latest':        'Most recent IPSS score (urinary symptom severity)',
    'PROST_LAB_ipss_max':           'Highest IPSS score recorded',
    'PROST_LAB_ipss_severe':        'IPSS severe (>=20) — heavy urinary symptom burden',
    'PROST_LAB_ipss_moderate':      'IPSS moderate (8-19)',
    'PROST_LAB_ipss_mild':          'IPSS mild (1-7)',
    'PROST_LAB_ca_latest':          'Latest serum calcium (mmol/L)',
    'PROST_LAB_ca_high':            'Calcium above upper-normal (>2.6 mmol/L)',
    'PROST_LAB_ca_very_high':       'Hypercalcaemia (>2.85 mmol/L) — bone-met correlate',
    'PROST_BONE_MET_TRIO':          'ALP elevated + calcium high + Hb low together (bone-met biomarker triad)',
    'PROST_BONE_MET_PAIR':          'Two of three bone-met biomarkers (ALP/Ca/Hb) abnormal',
    'PROST_BONE_MET_SCORE':         'Count of abnormal bone-met biomarkers (0-3)',
    'PROST_TRIFECTA_constit_urinary_bone_B': 'Constitutional + urinary + bone symptoms in same recent window (advanced-disease pattern)',
    'PROST_MULTISYSTEM_PAIR_B':     'Two of three (constitutional/urinary/bone) symptom systems in recent window',
    'PROST_FH_prostate_relevant':   'Family history of prostate or male-genital cancer',
    'PROST_FH_score':               'Weighted family-history score (prostate x2 + male-genital + any-cancer)',
