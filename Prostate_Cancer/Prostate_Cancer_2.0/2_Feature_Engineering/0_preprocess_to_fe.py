...
Reads:  data/raw/prostate_{window}_raw.csv   (output of SQL Queries/v3/{window}_v3.sql)
...
def main():
    ...
    if n_placeholder > 0:
        ...
        placeholder_df = build_placeholder_rows(sparse, sex_lookup, age_lookup)
    ...
    for c in ('PATIENT_GUID', 'SEX', 'TIME_WINDOW', 'EVENT_TYPE', 'CATEGORY', 'TERM', 'ASSOCIATED_TEXT'):
