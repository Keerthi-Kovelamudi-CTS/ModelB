...
def build_cancer_specific_features(clin_df, med_df, existing_fm, window_name, cfg=None):
    ...
    obs_AB = clin[clin['TIME_WINDOW'].isin(['all'])].copy()
    obs_A = clin[clin['TIME_WINDOW'] == 'all'].copy()
    obs_B = clin[clin['TIME_WINDOW'] == 'all'].copy()
    med_AB = med[med['TIME_WINDOW'].isin(['all'])].copy()
    med_A = med[med['TIME_WINDOW'] == 'all'].copy()
    med_B = med[med['TIME_WINDOW'] == 'all'].copy()
    ...
    try:
        ...
        psa_A = psa_all[psa_all['TIME_WINDOW'] == 'all'].groupby('PATIENT_GUID')['VALUE'].mean()
        psa_B = psa_all[psa_all['TIME_WINDOW'] == 'all'].groupby('PATIENT_GUID')['VALUE'].mean()
