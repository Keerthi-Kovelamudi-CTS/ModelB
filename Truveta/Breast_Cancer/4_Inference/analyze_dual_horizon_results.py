...
Inputs:
  ...
  - 2_Feature_Engineering/results/features/{1mo,12mo}/breast_feature_matrix.parquet
...
def add_cross_cell_shap(df):
    ...
    X_1mo  = (fm_1mo[fm_1mo["patient_id"].isin(test_guids)]
              .set_index("patient_id").reindex(test_guids))
    X_12mo = (fm_12mo[fm_12mo["patient_id"].isin(test_guids)]
              .set_index("patient_id").reindex(test_guids))
