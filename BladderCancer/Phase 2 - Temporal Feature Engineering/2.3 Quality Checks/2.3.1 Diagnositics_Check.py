...
# Usage: python diagnostics.py [--window 3mo|6mo|12mo]  (default: 12mo)
# ══════════════════════════════════════════════════════════════
...
parser.add_argument('--window', choices=['3mo', '6mo', '12mo'], default='12mo', help='Data window (default: 12mo)')
