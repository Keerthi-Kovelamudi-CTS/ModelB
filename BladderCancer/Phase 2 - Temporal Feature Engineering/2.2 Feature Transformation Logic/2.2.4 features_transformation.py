...
═══════════════════════════════════════════════════════════════
  ...
  Input:  data/{3mo|6mo|12mo}/ — 12mo: FE_bladder_dropped_patients_*_windowed.csv; 3mo/6mo: *_3m|6m.csv
  Output: FE_Results/{3mo|6mo|12mo}/ (bladder_feature_matrix_{window}.csv + meta, feature list, log)
  Usage: python 4_feature_engineering.py [--window 3mo|6mo|12mo]
═══════════════════════════════════════════════════════════════
"""
