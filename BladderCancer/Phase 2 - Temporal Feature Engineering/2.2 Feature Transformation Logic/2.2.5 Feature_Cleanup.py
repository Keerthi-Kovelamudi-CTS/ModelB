...
Input:  FE_Results/{3mo|6mo|12mo}/bladder_feature_matrix_{window}.csv
Output: cleanupfeatures/{3mo|6mo|12mo}/ (bladder_feature_matrix_{window}_cleaned.csv + feature list)
Usage: python 5_feature_cleanup.py [--window 3mo|6mo|12mo]  (default: 12mo)
"""
