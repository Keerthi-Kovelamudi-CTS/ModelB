...
-- ══════════════════════════════════════════════════════════════
-- APPROVED MEDS (ORIGINAL + SELECTIVE NEW)
-- Removed: NSAIDS (too general), VAGINAL ESTROGEN (sparse),
--          ERECTILE DYSFUNCTION (not cancer-specific)
-- Kept: iron (bleeding), opioids (pain), GI antispasmodics,
--       bladder antispasmodics, urinary retention drugs
-- ══════════════════════════════════════════════════════════════
approved_meds AS (
