"""
╔══════════════════════════════════════════════════════════════════╗
║  BREAST — Phase 1.4 (Clinical Review Bridge)                ║
║  Compare Ranking.py output vs. existing curated codelist.     ║
║                                                                ║
║  Inputs:                                                       ║
║    - Output/Scores_breast/breast_obs_all.csv               ║
║    - Output/Scores_breast/breast_meds_all.csv              ║
║    - ../codelists/breast_curated_codes_v2.tsv                ║
║                                                                ║
║  Outputs (Output/Compare_to_curated/):                         ║
║    - breast_obs_review.tsv                                   ║
║    - breast_meds_review.tsv                                  ║
...
CONFIG = {
    "cancer_type": "breast",
    "scores_dir": os.path.join(_SCRIPT_DIR, "Output", "Scores_breast"),
    "curated_tsv": os.path.join(
        _SCRIPT_DIR, "..", "codelists", "breast_curated_codes_v2.tsv"
    ),
    "output_dir": os.path.join(_SCRIPT_DIR, "Output", "Compare_to_curated"),
    "obs_all_csv": "breast_obs_all.csv",
    "meds_all_csv": "breast_meds_all.csv",
...
def load_ranked(csv_path, feature_type):
    if not os.path.exists(csv_path):
        raise FileNotFoundError(
            ...
            "  → Run Ranking.py first to produce breast_*_all.csv files."
        )
