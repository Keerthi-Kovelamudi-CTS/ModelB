...
def predict_unseen(window, data_path=None, explain=False, top_n=5):
    ...
    if data_path is None:
        # Default: look in 7_Holdout_Test
        data_path = SCRIPT_DIR.parent / '7_Holdout_Test' / 'results' / window / f'holdout_features_{window}.parquet'
    ...
    if is_multi_seed:
        ...
        # even if AGE_AT_INDEX gets dropped from selected_features (defensive).
        ages = (df['AGE_AT_INDEX'].values if 'AGE_AT_INDEX' in df.columns
