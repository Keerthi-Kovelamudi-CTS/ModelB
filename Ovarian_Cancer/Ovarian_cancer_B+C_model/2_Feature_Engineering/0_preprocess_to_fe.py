...
Reads:  data/raw/ovarian_{window}_raw.csv   (output of SQL Queries/v4/{window}_v4.sql)
Writes: data/{window}/ovarian_{window}.parquet  (single unified file — obs + med UNION'd)
...
DEFAULT_RAW = SCRIPT_DIR / "data" / "raw" / "ovarian_1mo_raw.csv"
...
def main():
    ...
    ap.add_argument("--prefix",  default="ovarian_1mo",             help="output filename prefix")
    args = ap.parse_args()
