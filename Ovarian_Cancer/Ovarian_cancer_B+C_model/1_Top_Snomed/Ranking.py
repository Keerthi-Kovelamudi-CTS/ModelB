"""
╔══════════════════════════════════════════════════════════════════╗
║  OVARIAN CANCER — Phase 1.3                                   ║
║  Combined Feature Ranking (Statistical + ML)                   ║
║                                                                ║
║  Input Files (from Data_Input/):                               ║
║    - Ovarian_positive_obs.csv, Ovarian_negative_obs.csv                  ║
║    - Ovarian_positive_med.csv, Ovarian_negative_med.csv                  ║
║                                                                ║
║  Output Files: output/Scores_ovarian/                         ║
...
CONFIG = {
    ...
    'input_files': {
        ...
        'pos_meds':        'Ovarian_positive_med.csv',
        'neg_meds':        'Ovarian_negative_med.csv',
    },
