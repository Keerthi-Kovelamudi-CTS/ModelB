# ═══════════════════════════════════════════════════════════════
# OVARIAN CANCER — CLINICAL + TEXT FEATURES MODELING
# Clinical-only features + text keyword features from ASSOCIATED_TEXT
# ═══════════════════════════════════════════════════════════════
...
VAL_RATIO = 0.10
TEST_RATIO = 0.15
SEEDS = [44]  # Best seed from 1_run_modeling.py (Ensemble AUC 0.8274)
...
RESULTS_PATH = SCRIPT_DIR / 'text_results'
