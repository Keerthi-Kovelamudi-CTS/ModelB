...
def main():
    ...
    print(f"{'='*60}")
    print(f"  OVARIAN — COMBINED EVALUATION")
    ...
    # Ensure same columns
    training_cancer_aligned = training_cancer[common_cols].copy()
    unseen_aligned = unseen_non_cancer[common_cols].copy()
