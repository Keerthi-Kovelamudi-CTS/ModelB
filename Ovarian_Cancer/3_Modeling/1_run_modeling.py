# ═══════════════════════════════════════════════════════════════
# OVARIAN CANCER — THRESHOLD TUNING
# Step 8: Find optimal threshold for 75%+ Sens, 65%+ Spec
# Fallback: 70%+ Sens, 65%+ Spec
# Run AFTER Step 7 modeling
# ═══════════════════════════════════════════════════════════════
...
VAL_RATIO = 0.10
TEST_RATIO = 0.15
SEEDS = [44]  # Best seed from run1 (Ensemble AUC 0.8274)
