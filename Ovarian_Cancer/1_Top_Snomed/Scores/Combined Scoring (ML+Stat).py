"""
╔══════════════════════════════════════════════════════════════════╗
║  PRODUCTION — OVARIAN CANCER — Phase 1.3                       ║
║  Combined Feature Ranking (Statistical + ML)                   ║
║  Version: 1.1 FINAL                                            ║
║                                                                ║
║  Input Files (from Data/):                                     ║
║    - Ovarian_positive_obs.csv                                  ║
║    - Ovarian_negative_obs.csv                                  ║
║    - Ovarian_positive_meds.csv                                 ║
║    - Ovarian_negative_meds.csv                                 ║
║    - Ovarian_patient_obs_matrix.csv (obs matrix)               ║
║    - Ovarian_patient_meds_matrix.csv (meds matrix)             ║
║                                                                ║
║  Output Files: Scores/output/Scores_ovarian/                   ║
║      - ovarian_obs_top150.csv                                  ║
║      - ovarian_meds_top150.csv                                 ║
║      - ovarian_combined_top150.csv     ← FINAL DELIVERABLE     ║
║      - ovarian_obs_all.csv                                     ║
║      - ovarian_meds_all.csv                                    ║
║      - ovarian_combined_all.csv                                ║
...
║                                                                ║
║  Run: python PROD_ovarian_feature_ranking_FINAL.py             ║
...
CONFIG = {
    ...
    'data_dir': _DATA_DIR,
    'input_files': {
        'pos_obs':         'Ovarian_positive_obs.csv',
        'neg_obs':         'Ovarian_negative_obs.csv',
        'pos_meds':        'Ovarian_positive_meds.csv',
        'neg_meds':        'Ovarian_negative_meds.csv',
        'obs_matrix':      'Ovarian_patient_obs_matrix.csv',
        'meds_matrix':     'Ovarian_patient_meds_matrix.csv',
    },

    # Output
    'output_dir': os.path.join(_SCRIPT_DIR, 'output', 'Scores_ovarian'),
