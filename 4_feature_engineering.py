...
═══════════════════════════════════════════════════════════════
  ...
  Input:  data/{3mo|6mo}/FE_bladder_dropped_patients_*_windowed_3m|6m.csv
  Output: FE_Results/{3mo|6mo}/ (bladder_feature_matrix_3mo|6mo.csv + meta, feature list, log)
  Usage: python 4_feature_engineering.py [--window 6mo|3mo]
═══════════════════════════════════════════════════════════════
"""
...
parser.add_argument('--window', choices=['3mo', '6mo'], default='3mo', help='3mo or 6mo window (default: 3mo)')
