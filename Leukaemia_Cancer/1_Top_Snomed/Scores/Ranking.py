"""
╔══════════════════════════════════════════════════════════════════╗
║  PRODUCTION — LEUKEMIA (ALL SUBTYPES) — Phase 1.3              ║
║  Combined Feature Ranking (Statistical + ML)                   ║
║  Version: 1.1 FINAL                                            ║
║                                                                ║
║  Input Files (from Data_Input/):                               ║
║    - leuk_obs_pos.csv, leuk_obs_neg.csv                        ║
║    - leuk_med_pos.csv, leuk_med_neg.csv                        ║
║    - leuk_patient_obs_matrix.csv  (optional)                   ║
║    - leuk_patient_meds_matrix.csv (optional)                   ║
║                                                                ║
║  Output Files: Scores/output/Scores_leukemia/                  ║
║      - leukemia_obs_top150.csv                                 ║
║      - leukemia_meds_top150.csv                                ║
║      - leukemia_combined_top150.csv     ← FINAL DELIVERABLE   ║
║      - leukemia_obs_all.csv                                    ║
║      - leukemia_meds_all.csv                                   ║
║      - leukemia_combined_all.csv                               ║
...
║                                                                ║
║  Run: python PROD_leukemia_feature_ranking_FINAL.py            ║
...
CONFIG = {
    ...
    'data_dir': _DATA_DIR,
    'input_files': {
        'pos_obs':         'leuk_obs_pos.csv',
        'neg_obs':         'leuk_obs_neg.csv',
        'pos_meds':        'leuk_med_pos.csv',
        'neg_meds':        'leuk_med_neg.csv',
        'obs_matrix':      'leuk_patient_obs_matrix.csv',
        'meds_matrix':     'leuk_patient_meds_matrix.csv',
    },
    ...
    'output_dir': os.path.join(_SCRIPT_DIR, 'output', 'Scores_leukemia'),
...
def _read_csv_safe(filepath, code_col):
    """Read CSV preserving long code IDs as strings."""
    # dtype keys must match file headers before lowercasing (e.g. SNOMED_ID, MED_CODE_ID)
