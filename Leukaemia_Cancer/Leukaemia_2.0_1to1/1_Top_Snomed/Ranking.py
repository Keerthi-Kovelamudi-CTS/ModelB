"""
╔══════════════════════════════════════════════════════════════════╗
║  LEUKAEMIA CANCER — Phase 1.3                                   ║
║  Combined Feature Ranking (Statistical + ML)                   ║
║                                                                ║
║  Input Files (from Data_Input/):                               ║
║    - Leukaemia_positive_obs.csv, Leukaemia_negative_obs.csv                  ║
║    - Leukaemia_positive_med.csv, Leukaemia_negative_med.csv                  ║
║                                                                ║
║  Output Files: output/Scores_leukaemia/                         ║
║      - leukaemia_obs_top150.csv                                 ║
║      - leukaemia_meds_top150.csv                                ║
║      - leukaemia_combined_top150.csv     ← FINAL DELIVERABLE   ║
║      - leukaemia_obs_all.csv                                    ║
║      - leukaemia_meds_all.csv                                   ║
║      - leukaemia_combined_all.csv                               ║
...
CONFIG = {
    ...
    'data_dir': _DATA_DIR,
    'input_files': {
        'pos_obs':         'Leukaemia_positive_obs.csv',
        'neg_obs':         'Leukaemia_negative_obs.csv',
        'pos_meds':        'Leukaemia_positive_med.csv',
        'neg_meds':        'Leukaemia_negative_med.csv',
    },
    ...
    'output_dir': os.path.join(_SCRIPT_DIR, 'output', 'Scores_leukaemia'),
