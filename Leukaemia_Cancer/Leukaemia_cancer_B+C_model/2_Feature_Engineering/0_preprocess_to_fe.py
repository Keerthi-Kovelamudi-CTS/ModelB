...
Reads:  data/raw/leukaemia_{window}_raw.csv   (output of SQL Queries/v4/{window}_v4.sql)
Writes: data/{window}/leukaemia_{window}.parquet  (single unified file — obs + med UNION'd)
...
def main():
    ...
    ap.add_argument("--prefix",  default="leukaemia_1mo",           help="output filename prefix")
    args = ap.parse_args()
