"""
Drop meds-only patients. Inputs from data/{3mo|6mo|12mo|12mo_250k}/; outputs to same data/{window}/.
12mo: no suffix; 12mo_250k: _12m_250k; 3mo/6mo: _3m/_6m.
Usage: python 3_droppatients.py [--window 3mo|6mo|12mo|12mo_250k]  (default: 12mo_250k)
"""
import os
import argparse
import pandas as pd
...
if WINDOW == '12mo':
    ...
    OUT_CLINICAL = os.path.join(DATA_DIR, 'FE_bladder_dropped_patients_clinical_windowed_12m_250k.csv')
    OUT_MEDS = os.path.join(DATA_DIR, 'FE_bladder_dropped_patients_med_windowed_12m_250k.csv')
else:
