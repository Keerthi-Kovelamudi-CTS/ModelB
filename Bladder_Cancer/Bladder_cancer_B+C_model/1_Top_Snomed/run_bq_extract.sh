#!/bin/bash
# ════════════════════════════════════════════════════════════════
# Bladder_2.0_1to1 — Phase 1.1: Run 4 P1 SQLs on BigQuery and
...
#
# Output:
#   Data_Input/Bladder_positive_obs.csv
#   Data_Input/Bladder_negative_obs.csv
#   Data_Input/Bladder_positive_med.csv
#   Data_Input/Bladder_negative_med.csv
#
...
run_pos_obs () {
  run_one \
    ...
    "$OUT_DIR/Bladder_positive_obs.csv" \
...
run_neg_obs () {
  run_one \
    ...
    "$OUT_DIR/Bladder_negative_obs.csv" \
...
run_pos_med () {
  run_one \
    ...
    "$OUT_DIR/Bladder_positive_med.csv" \
...
run_neg_med () {
  run_one \
    ...
    "$OUT_DIR/Bladder_negative_med.csv" \
