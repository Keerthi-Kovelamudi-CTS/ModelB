"""
╔══════════════════════════════════════════════════════════════════╗
║  BLADDER — Phase 1.4 (Clinical Review Bridge)                ║
║  Compare Ranking.py output vs. existing curated codelist.     ║
║                                                                ║
║  Inputs:                                                       ║
║    - Output/Scores_bladder/bladder_obs_all.csv               ║
║    - Output/Scores_bladder/bladder_meds_all.csv              ║
║    - ../codelists/bladder_curated_codes_v2.tsv                ║
║                                                                ║
║  Outputs (Output/Compare_to_curated/):                         ║
║    - bladder_obs_review.tsv                                   ║
║    - bladder_meds_review.tsv                                  ║
║    - bladder_combined_review.tsv                              ║
...
CONFIG = {
    "cancer_type": "bladder",
    "scores_dir": os.path.join(_SCRIPT_DIR, "Output", "Scores_bladder"),
    "curated_tsv": os.path.join(
        _SCRIPT_DIR, "..", "codelists", "bladder_curated_codes_v2.tsv"
    ),
    "output_dir": os.path.join(_SCRIPT_DIR, "Output", "Compare_to_curated"),
    "obs_all_csv": "bladder_obs_all.csv",
    "meds_all_csv": "bladder_meds_all.csv",
...
def load_ranked(csv_path, feature_type):
    if not os.path.exists(csv_path):
        raise FileNotFoundError(
            ...
            "  → Run Ranking.py first to produce bladder_*_all.csv files."
        )
