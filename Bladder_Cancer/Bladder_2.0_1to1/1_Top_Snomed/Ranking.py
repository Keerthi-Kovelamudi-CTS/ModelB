"""
╔══════════════════════════════════════════════════════════════════╗
║  BLADDER CANCER — Phase 1.3                                   ║
║  Combined Feature Ranking (Statistical + ML)                   ║
║                                                                ║
║  Input Files (from Data_Input/):                               ║
║    - Bladder_positive_obs.csv, Bladder_negative_obs.csv                  ║
║    - Bladder_positive_med.csv, Bladder_negative_med.csv                  ║
║                                                                ║
║  Output Files: output/Scores_bladder/                         ║
║      - bladder_obs_top150.csv                                 ║
║      - bladder_meds_top150.csv                                ║
║      - bladder_combined_top150.csv     ← FINAL DELIVERABLE   ║
║      - bladder_obs_all.csv                                    ║
...
CONFIG = {
    ...
    'input_files': {
        ...
        'pos_meds':        'Bladder_positive_med.csv',
        'neg_meds':        'Bladder_negative_med.csv',
    },
    ...
    'output_dir': os.path.join(_SCRIPT_DIR, 'output', 'Scores_bladder'),
